...
to init-network
  ...
  set-default-shape exchangers "square"
  ...
  ask n-of init-infected-num nodes[
    if color = white[
     set color red]]
end
...
"healthy" 1.0 0 -16777216 true "" ""
"resistant" 1.0 0 -13345367 true "" ""
